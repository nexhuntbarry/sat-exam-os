...
<head>
  ...
  <title>Teacher Invitation — SAT Exam OS</title>
</head>
          ...
          <tr>
            <td>
              <h1 style="color:#FFFFFF;font-size:22px;font-weight:700;margin:0 0 16px;">
                You&rsquo;re invited to teach!
              </h1>
              <p style="color:#CBD5E1;font-size:15px;line-height:1.7;margin:0 0 24px;">
                You've received a teacher invitation${fromText} for SAT Exam OS &mdash;
                an AI-powered SAT test management platform.
              </p>
